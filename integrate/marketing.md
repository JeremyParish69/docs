...
- Can really be any amount, but should at least be worth the OMM Sponsorship amounts.
...
### Updates from the Lab Sponsorship

The Osmosis Ministray of Marketing runs a Twitter Spaces event called 'Updates from the Lab' each week where key foundation members (often, Sunny Aggarwal), special guests, and various hosts can discuss goings-on with Osmosis and special events. For a small sponsorship, our hosts can briefly talk about a project, new listings, new external incentives, upcoming governance propsals, etc.
